...
<div class="page-header">
	<h1><spring:message code="label.mifareManagement.searchPerson" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
...
<script type="text/javascript">
	function processDelete(externalId) {
		url = "${pageContext.request.contextPath}/cgd/mifaremanagement/person/search/delete/" + externalId;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><spring:message code = "label.mifareManagement.searchPerson.confirmDelete"/></p>
      </div>
...
"actions" :
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/cgd/mifaremanagement/person/search/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
                "" },
            </c:forEach>
    ];
