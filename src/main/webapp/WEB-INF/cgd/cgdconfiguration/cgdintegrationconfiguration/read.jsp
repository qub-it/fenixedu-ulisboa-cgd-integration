...
<div class="page-header">
	<h1><spring:message code="label.cgdConfiguration.readCgdIntegrationConfiguration" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/cgd/cgdconfiguration/cgdintegrationconfiguration/update/${cgdIntegrationConfiguration.externalId}"  ><spring:message code="label.event.update" /></a>
|&nbsp;&nbsp;</div>
...
<table class="table">
		<tbody>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.CgdIntegrationConfiguration.memberIDResolverClass"/></th> 
	<td>
